...
extern  int h,k;  //hÎªÊµ¼ÊĞĞÊı£¬kÎª²É¼¯Êı×éĞĞÊı
extern  unsigned char image[row][line];		//²É¼¯Ô­Ê¼Í¼Ïñ¶şÎ¬Êı×é
extern  int left[row];             //×ó±ß½çÊı×é
extern  int right[row];            //ÓÒ±ß½çÊı×é
extern  int bottom[row];           //ÖĞÏßÊı×é
int ph;
int dxwidth[row];
float error_sum;
